...
<body>
	...
	<br><br>
	<center><h1>Delete Staff</h1><br>
	<p>Enter 'ID' of Staff you want to delete.<p><br></center>

	<center><form action="delStaff1.php" method="post">
		<label>Staff ID:</label><input type="text" name="reg" required><br><br>
