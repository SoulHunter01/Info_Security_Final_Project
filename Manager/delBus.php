...
<body>
	...
	<br><br>
	<center><h1>Delete Bus</h1><br>
	<p>Enter 'Registration #' of Bus you want to delete.<p><br></center>

	<center><form action="delBus1.php" method="post">
		<label>Registration #:</label><input type="text" name="reg" placeholder="SGM-1234" required><br><br>
